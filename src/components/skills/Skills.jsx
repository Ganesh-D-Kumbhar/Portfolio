      ...
      >
        ...
        <div className="flex items-center mb-8">
          <div className="relative">
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl opacity-0 group-hover:opacity-20 blur-sm transition-opacity duration-300" />
          </div>
          <div className="ml-5">
            ...
            >
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10 hover:border-indigo-400/40 hover:bg-white/10 transition-all duration-200 hover:scale-105">
                ...
                <div className="w-full bg-white/10 rounded-full h-1.5 mt-3">
                  <motion.div
                    className="h-1.5 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full"
                    initial={{ width: 0 }}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <div className="relative">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl opacity-0 group-hover:opacity-30 blur-sm transition-opacity duration-300" />
            </div>
            <div className="ml-4">
...
const StatsCard = ({ stat, delay = 0 }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 rounded-xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      ...
      <div className="relative bg-gray-900/40 backdrop-blur-sm border border-indigo-500/20 rounded-xl p-6 hover:border-indigo-500/40 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-indigo-500/10">
        <div className="text-center">
          <div className="relative mb-4">
            ...
            <div className="absolute -inset-2 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl opacity-0 group-hover:opacity-20 blur-lg transition-opacity duration-300" />
          </div>
          <motion.h3
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        >
          <motion.div
            className="inline-flex items-center bg-gradient-to-r from-indigo-500/10 to-purple-500/10 backdrop-blur-sm border border-indigo-500/30 rounded-full px-6 py-3 mb-8"
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {otherSkills.map((skill, index) => (
              <SkillItem key={skill.name} skill={skill} delay={index * 0.1} />
            ))}
          </div>
        </motion.div>
