...
const PopUpForm = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="relative bg-white rounded-2xl shadow-2xl w-full max-w-xl mx-auto transform opacity-0 animate-slide-up"
        ...
        <div className="p-8">
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full bg-gradient-to-r from-[rgb(117,78,249)] to-[rgb(147,108,255)] text-white font-semibold py-4 px-6 rounded-xl shadow-lg shadow-[rgb(117,78,249)]/25 hover:shadow-[rgb(117,78,249)]/40 transition-all duration-200 flex items-center justify-center space-x-2 disabled:opacity-70 disabled:cursor-not-allowed transform cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
            >
              {isSubmitting ? (
                <>
