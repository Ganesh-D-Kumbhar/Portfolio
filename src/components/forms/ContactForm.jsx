...
//                 className="w-full relative overflow-hidden bg-gradient-to-r from-indigo-500 to-indigo-600 text-white px-8 py-6 rounded-2xl font-bold text-lg shadow-2xl shadow-indigo-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 group cursor-pointer"
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }}>
            ...
            <div className="relative group">
              ...
              <textarea
                ...
                onBlur={formik.handleBlur}
                disabled={formik.isSubmitting}
                className={`w-full bg-gray-800/60 border-2 rounded-2xl pl-12 pr-4 py-4 text-white placeholder-gray-400 focus:outline-none transition-all duration-200 resize-none ${
                  formik.touched.msg && formik.errors.msg
                    ? "border-red-400 focus:border-red-400 focus:shadow-lg focus:shadow-red-500/20"
                    : "border-indigo-500/30 focus:border-indigo-400 focus:shadow-lg focus:shadow-indigo-500/20 hover:border-indigo-400/50"
                }`}
